...
export const experiences = [
    ...
    },
    {
        ...
        points: [
            "Designed interactive web animations such as the (Card Hover Effect) and (Toggle Switch) to boost user engagement and website appeal.",
            ...
            "Developed a library of HTML, CSS, JS, and React components to create dynamic 3D animations for web designs",
            ...
            "Focused on reusable, scalable solutions such as animated 3D cards, built using advanced CSS techniques and 3D transformations.",

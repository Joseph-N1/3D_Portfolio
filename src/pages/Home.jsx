...
const Home = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      // Update state or ref here with new values
      // Since this is just a sample, you may need to update state or refs appropriately
    };
      ...
      >
        <Suspense fallback={<Loader />}>
          ...
          <Plane
            ...
            rotation={[0, 20, 0]} // Ensure rotation is passed correctly
          />
        </Suspense>
      </Canvas>
